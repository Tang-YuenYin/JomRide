...
public class RideData implements Serializable {
    ...
    public RideData(){}
    public RideData(String datetime, double price, int point, String transport, double rate, double distance, double duration, String start, String end,String bike_code) {
