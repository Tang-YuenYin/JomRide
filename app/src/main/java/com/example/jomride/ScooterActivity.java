...
public class ScooterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countingIntent = new Intent(ScooterActivity.this, CountingActivity.class);
        feedbackIntent = new Intent(ScooterActivity.this, FeedbackListActivity.class);
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ScooterActivity.this,TransportActivity.class);
    ...
    private void showPopupDialog(){
        mDialog.setContentView(R.layout.activity_codescooter);
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValidCode(enteredCode)) {
                    ...
                    Intent intent = new Intent(ScooterActivity.this, UnlockedActivity.class);
                    startActivityForResult(intent, 1); // '1' is the requestCode, you can use any unique value

                    // Close the dialog
                    mDialog.dismiss();
                } else {
                    Toast.makeText(ScooterActivity.this, "Invalid code. Please try again", Toast.LENGTH_SHORT).show();
                }
            }
        });
        mDialog.show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1) { // Assuming requestCode 1 is for UnlockedActivity
            if (resultCode == RESULT_OK) {
                ...
                countingIntent.putExtra("VehicleType", "Scooter");
    ...
    private boolean isValidCode(String code) {
        return code.equals("S101") || code.equals("S102") || code.equals("S103") || code.equals("S104") || code.equals("S105");
    }
