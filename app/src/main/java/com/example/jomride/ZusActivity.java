...
public class ZusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button redeemButton = findViewById(R.id.redeemzus);
    ...
    private void startNewActivity(Class<?> cls) {
        Intent intent = new Intent(ZusActivity.this, cls);
            ...
            public void onDataChange(DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if(currentPoints >= redeemedPoints) {
                        ...
                        Toast.makeText(ZusActivity.this, "Insufficient Points", Toast.LENGTH_SHORT).show();
                    }
                }
            }
