...
public class TealiveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tealive);
        ...
        Button redeemButton = findViewById(R.id.redeemtealive);
    ...
    private void startNewActivity(Class<?> cls) {
        Intent intent = new Intent(TealiveActivity.this, cls);
            ...
            public void onDataChange(DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if(currentPoints >= redeemedPoints) {
                        ...
                        Toast.makeText(TealiveActivity.this, "Insufficient Points", Toast.LENGTH_SHORT).show();
                    }
                }
            }
