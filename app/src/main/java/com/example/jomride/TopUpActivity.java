...
//                                                  Toast toast1 = Toast.makeText(TopUpActivity.this ," currentcredit "+currentCredit, Toast.LENGTH_SHORT);
//                                                  toast1.show();
...
//                                                  toast.show();
                                                  if(amount>=limit)
                                                  {
                                                      ...
                                                      ETamount.getText().clear();
                                                      Toast toast2 = Toast.makeText(TopUpActivity.this ," Only can top up value more than \nRM "+limit, Toast.LENGTH_SHORT);
                                                      toast2.show();
                                                  }
...
//                    toast2.show();
        ...
        ImageButton BtnBackHome=findViewById(R.id.BtnBack_WalletTopUpHome);
    ...
    private void onPaymentResult(PaymentSheetResult paymentSheetResult) {
        if (paymentSheetResult instanceof PaymentSheetResult.Canceled) {
            ...
            walletRef.setValue(new WalletData(tbalance, walletdata.getPoint()));
            ETamount.getText().clear();
            Btntopup.setEnabled(false);
        }
    }
...
//    }
    ...
    private double getTotalBalance(double amount)
    {
        ...
        double total= Double.parseDouble(walletdata.getBalance())+amount;
        Toast.makeText(TopUpActivity.this,String.format("New balance: RM%f",total), Toast.LENGTH_SHORT).show();
        return total;
    }
