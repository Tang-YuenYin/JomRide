...
public class Rent1free1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rent1free1);
        ...
        Button redeemButton = findViewById(R.id.redeemrent);

        redeemButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int redeemedPoints = 1000; // Number of points to redeem
    ...
    private void startNewActivity(Class<?> cls) {
        Intent intent = new Intent(Rent1free1.this, cls);
            ...
            public void onDataChange(DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if(currentPoints >= redeemedPoints) {
                        ...
                        Toast.makeText(Rent1free1.this, "Insufficient Points", Toast.LENGTH_SHORT).show();
                    }
                }
            }
