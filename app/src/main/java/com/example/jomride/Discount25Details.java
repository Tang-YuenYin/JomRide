...
public class Discount25Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_discount25_details);
        ...
        Button redeemButton = findViewById(R.id.discount25redeem);
    ...
    private void startNewActivity(Class<?> cls) {
        Intent intent = new Intent(Discount25Details.this, cls);
            ...
            public void onDataChange(DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if(currentPoints >= redeemedPoints) {
                        ...
                        Toast.makeText(Discount25Details.this, "Insufficient Points", Toast.LENGTH_SHORT).show();
                    }
                }
            }
