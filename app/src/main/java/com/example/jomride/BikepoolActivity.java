...
public class BikepoolActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bikepool);
        ...
        countingIntent = new Intent(BikepoolActivity.this, CountingActivity.class);
        feedbackIntent = new Intent(BikepoolActivity.this, FeedbackListActivity.class);
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(BikepoolActivity.this,TransportActivity.class);
    ...
    private void showPopupDialog(){
        mDialog.setContentView(R.layout.activity_codebikepool);
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isValidCode(enteredCode)) {
                    ...
                    Intent intent = new Intent(BikepoolActivity.this, UnlockedActivity.class);
                    startActivityForResult(intent, 1); // '1' is the requestCode, you can use any unique value

                    // Close the dialog
                    mDialog.dismiss();
                } else {
                    Toast.makeText(BikepoolActivity.this, "Invalid code. Please try again", Toast.LENGTH_SHORT).show();
                }
            }
        });
        mDialog.show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1) { // Assuming requestCode 1 is for UnlockedActivity
            if (resultCode == RESULT_OK) {
                ...
                countingIntent.putExtra("VehicleType", "BikePooling");
    ...
    private boolean isValidCode(String code) {
        return code.equals("P101") || code.equals("P102") || code.equals("P103") || code.equals("P104") || code.equals("P105");
    }
}