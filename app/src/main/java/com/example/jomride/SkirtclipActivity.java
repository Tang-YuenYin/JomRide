...
public class SkirtclipActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.skirtclip);
        ...
        Button redeemButton = findViewById(R.id.redeemskirtclip);

        redeemButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int redeemedPoints = 400; // Number of points to redeem
    ...
    private void startNewActivity(Class<?> cls) {
        Intent intent = new Intent(SkirtclipActivity.this, cls);
            ...
            public void onDataChange(DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if(currentPoints >= redeemedPoints) {
                        ...
                        Toast.makeText(SkirtclipActivity.this, "Insufficient Points", Toast.LENGTH_SHORT).show();
                    }
                }
            }
