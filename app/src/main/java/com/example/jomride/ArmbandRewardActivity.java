...
public class ArmbandRewardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.armband);
        ...
        Button redeemButton = findViewById(R.id.armbandredeem);
    ...
    private void startNewActivity(Class<?> cls) {
        Intent intent = new Intent(ArmbandRewardActivity.this, cls);
            ...
            public void onDataChange(DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if(currentPoints >= redeemedPoints) {
                        ...
                        Toast.makeText(ArmbandRewardActivity.this, "Insufficient Points", Toast.LENGTH_SHORT).show();
                    }
                }
            }
